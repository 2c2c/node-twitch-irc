    ...
    return (
      ...
      <hr />
        ...
        <span style={{
          ...
          <TwitchButton onClick={(c) => client.r9kbeta(client.lastJoined)}>R9K</TwitchButton>
          <TwitchButton onClick={(c) => client.slow(client.lastJoined)}>Slow</TwitchButton>
          <TwitchButton onClick={(c) => client.subscribers(client.lastJoined)}>Sub</TwitchButton>
