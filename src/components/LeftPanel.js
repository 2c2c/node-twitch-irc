...
export default class LeftPanel extends Component {
  render() {
    const {client, popularWords, toggleFilter, showStreamPreview, toggleStreamPreview} = this.props;
    if (!client) {
      return null;
    }
    return (
      <div style={{
        ...
        <PopularWordList toggleFilter={toggleFilter} popularWords={popularWords}/>
      </div>
    );
  }
};
