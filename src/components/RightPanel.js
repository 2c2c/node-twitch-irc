...
export default class RightPanel extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    nextProps.client.on('join', (channel, username, self) => {
      ...
      axios.get(`http://tmi.twitch.tv/group/user/${channel}/chatters`,
      {
  ...
  render() {
    ...
    return (
      <div style={{
        ...
        <UserList focusedUser={focusedUser} handleFocusedUser={(user) => handleFocusedUser(user)} name="mods" userlist={mods}/>
        <UserList focusedUser={focusedUser} handleFocusedUser={(user) => handleFocusedUser(user)} name="staff" userlist={staff}/>
        <UserList focusedUser={focusedUser} handleFocusedUser={(user) => handleFocusedUser(user)} name="admins" userlist={admins}/>
        <UserList focusedUser={focusedUser} handleFocusedUser={(user) => handleFocusedUser(user)} name="global_mods" userlist={global_mods}/>
        <UserList focusedUser={focusedUser} handleFocusedUser={(user) => handleFocusedUser(user)} name="users" userlist={viewers}/>
